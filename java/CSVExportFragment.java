...
public class CSVExportFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        checkPerms();
        System.out.println(isExternalStorageAvailable + " " + isExternalStorageWritable);
    }
    ...
    public void sendCSVFile(View view){
        if (!isExternalStorageWritable){ // ensure we can create a file
            Toast.makeText(getContext(), R.string.storagePermissionError, Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        try {
            ...
            Toast.makeText(this.getContext(), "Error During CSV File Generation", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CREATE_FILE_ACTIVITY){
            ...
            ArrayList<Action> actions = DatabaseTools.getActionsOfUser(mParam1); // get all the actions
            ...
            try {
                ...
                e.printStackTrace();
                Toast.makeText(getContext(), R.string.fileCreationError, Toast.LENGTH_SHORT).show();
            }
        }
    }
