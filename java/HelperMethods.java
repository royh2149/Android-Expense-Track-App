...
public class HelperMethods {
    ...
    public static int PasswordStrength(String pass){
        ...
        for (int i = 0; i < pass.length(); i++) {
            ...
            if (digit == 1 && letter == 1 && symbol == 1){
                break; // password is strong enough, no need to continue checking
            }
        }
    ...
    /**
     * Displays an alert dialog with the specified title and description
     * @param context a reference to the relevant activity
     * @param title the title of the dialog
     * @param description the content of the dialog
     */
    public static void showAlertDialog(Context context, String title, String description){
        AlertDialog.Builder builder = new AlertDialog.Builder(context); // initialize the builder
        builder.setCancelable(true); // exit when the user types outside
